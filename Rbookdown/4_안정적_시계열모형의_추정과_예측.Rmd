...
### 4.3.4 AR(p) 모형의 MA($\infty$) 모형으로의 전환
...
## 4.5 자기회귀 - 이동평균모형(ARMA(p,q) models)
...
## 4.7 적정 ARMA(p,q)모형 선정 절차 - Diagnostic Checking

## 4.8 ARMA 모형의 예측

### 4.8.1 ARMA (p,q) 모형의 예측의 기본원리

### 4.8.2 예측오차

### 4.8.3 ARMA(p,q)모형의 최소 MSE 예측

## 4.9 Fractionally Integrated ARMA 과정 : FARIMA(p,d,q)
